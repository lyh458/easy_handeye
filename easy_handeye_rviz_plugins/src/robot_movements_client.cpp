...
std::vector<std::string> RobotMovementsClient::listRunningCalibrations()
{
...
bool RobotMovementsClient::getSampleList(easy_handeye_msgs::SampleList& out)
{
...
bool RobotMovementsClient::takeSample(easy_handeye_msgs::SampleList& new_list)
{
  easy_handeye_msgs::TakeSample r;
...
bool RobotMovementsClient::removeSample(size_t index, easy_handeye_msgs::SampleList& new_list)
{
...
bool RobotMovementsClient::computeCalibration(easy_handeye_msgs::HandeyeCalibration& result)
{
...
bool RobotMovementsClient::saveCalibration()
{
  std_srvs::Empty r;
